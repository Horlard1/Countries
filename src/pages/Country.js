...
const Country = ({isDark}) => {
  ...
  return (
    <div className={`container mt-5 w-5/6 mx-auto ${isDark ? "dark": ''}`}>
        <div className='flex flex-col mt-10 w-full lg:w-5/6'>
            ...
            {country.length > 0 && country.map((detail, index)=>(
                <div key={index} className={`flex justify-between flex-col lg:flex-row w-full md:w-5/6 md:mx-auto ${isDark ?'dark-desc': ''}`}>
